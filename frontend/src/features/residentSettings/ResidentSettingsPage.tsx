      ...
      <section className="rounded-[2rem] border border-[#E5E7EB] bg-white p-5 shadow-sm sm:p-6 lg:p-7">
        <div className="border-b border-[#E5E7EB] pb-6">
          ...
          <p className="mt-2 text-sm font-semibold text-[#6B7280]">
            Ajuste os dados do seu perfil no MORAÊ.
          </p>
        </div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-5 lg:grid-cols-2">
          <SettingsBlock
            ...
            description="Foto, nome, telefone, e-mail e unidades vinculadas."
      ...
      <div className="space-y-6">
        ...
        <form onSubmit={(event) => void handleSubmit(event)} className="space-y-6">
          ...
          <div className="rounded-[1.5rem] border border-[#E5E7EB] bg-[#F9FAFB] p-5">
            <p className="text-sm font-black text-[#111827]">Unidades vinculadas</p>
        ...
        {isLoading ? (
          ...
          <>
            <ToggleRow
              ...
              description="Receber destaque para novos comunicados."
              checked={preferences.noticesEnabled}
              onChange={() => updatePreference("noticesEnabled")}
            />
            <ToggleRow
              label="Lembretes de boletos"
            ...
            />
            <ToggleRow
              label="Atualizações da unidade"
              description="Receber avisos relacionados às suas unidades."

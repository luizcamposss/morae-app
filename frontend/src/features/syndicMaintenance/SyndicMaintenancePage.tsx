                          ...
                          <select
                            ...
                            onChange={(event) =>
                              void handleStatusChange(
                                occurrence.id,
                                Number(event.target.value) as OccurrenceStatus,
                              )
                            }
                            className="h-9 cursor-pointer rounded-xl border border-[#E5E7EB] bg-white px-3 text-xs font-black text-[#6B7280] outline-none transition focus:border-[#22C55E] focus:ring-4 focus:ring-[#86EFAC]/30"
                          >
            ...
            >
              {units.map((unit) => (
                <option key={unit.id} value={unit.id}>
                  {unit.buildingName} - Unidade {unit.number}
                </option>
              ))}
            </select>
          </label>
